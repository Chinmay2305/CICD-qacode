...
import automation.PageObject.PageObject_Inventories_RepairOrders;
import io.opentelemetry.sdk.autoconfigure.spi.ConfigProperties;

public class InventoriesRepairOrdersTest extends BaseTest
{
	private PageObject_Inventories_RepairOrders pi;

	@BeforeTest
	public void setup() throws IOException, InterruptedException
	{
		super.setup();
		pi = new PageObject_Inventories_RepairOrders(driver);
	}
	...
	public void repairordersinventories() throws Exception
	{

...
import automation.PageObject.PageObject_Inventories_Pipeline;
import io.opentelemetry.sdk.autoconfigure.spi.ConfigProperties;

public class InventoriesPipelineTest extends BaseTest
{
	private PageObject_Inventories_Pipeline pi;

	@BeforeTest
	public void setup() throws IOException, InterruptedException
	{
		super.setup();
		pi = new PageObject_Inventories_Pipeline(driver);
	}
	...
	{
		driver.get("https://qa.aerfinity.acumenaviation.in/inventory/pipeline-teardown");

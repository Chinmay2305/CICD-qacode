...
public class InventoriesSlowMovingTest extends BaseTest
{
	private PageObject_Inventories_SlowMoving ps;

	@BeforeTest
	public void setup() throws IOException, InterruptedException
	{
		super.setup();
		ps = new PageObject_Inventories_SlowMoving(driver);
	}
	...
	public void slowmovinginventories() throws Exception
	{
		ps.filterinventories();
		//ps.sortinventories();
		//ps.columnconfiguration();
	}
